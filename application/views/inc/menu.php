<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
  ...
  <ul class="nav am-sideleft-menu">
            ...
            <li class="nav-item">
              ...
              <ul class="nav-sub">
                <li class="nav-item"><a href="<?php echo base_url(); ?>index.php/equipes/ajouter" class="nav-link">Ajouter une équipe</a></li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav-sub">
                <li class="nav-item"><a href="<?php echo base_url(); ?>index.php/rencontres/ajouter" class="nav-link">Ajouter une rencontre</a></li>
